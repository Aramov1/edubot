...
def generate_launch_description():
    ...
    hw_position_launch_file = os.path.join(
        lerobot_pkg_dir, 
        'launch', 
        'hw_position.launch.py'
    )
    
    # Include the sim_position launch file
    hw_position_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(hw_position_launch_file)
    )
