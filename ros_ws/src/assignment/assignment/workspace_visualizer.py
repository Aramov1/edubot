...
# Resolve project root dynamically so the node works on any machine.
# File lives at: <project_root>/ros_ws/src/assignment/assignment/workspace_visualizer.py
_THIS_DIR    = os.path.dirname(os.path.abspath(__file__))   # .../assignment/assignment/
_PKG_DIR     = os.path.dirname(_THIS_DIR)                   # .../assignment/  (ROS pkg)
_SRC_DIR     = os.path.dirname(_PKG_DIR)                    # .../src/
_ROS_WS_DIR  = os.path.dirname(_SRC_DIR)                   # .../ros_ws/
_PROJECT_ROOT = os.path.dirname(_ROS_WS_DIR)                # .../edubot/
sys.path.insert(0, os.path.join(_PROJECT_ROOT, 'assignment'))
